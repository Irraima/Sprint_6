class AboutRentLocators:
    ...
    DATE = ".//input[@placeholder='* Когда привезти самокат']"

    RENT_TIME = ".//div[@class = 'Dropdown-control']"

    CHOOSE_RENT_TIME_THREE_DAYS = "//*[@id='root']/div/div[2]/div[2]/div[2]/div[2]/div[3]"
