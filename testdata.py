...
class OrderData:
    metro = ['Соколиная Гора', 'Сокол', 'Динамо']
    user = [['Наруто', 'Узумаки', 'Автомоторная, 2', random.choice(metro), 'grey', f'+7{randint(0000000000, 9999999999)}'],
            ['Саске', 'Учиха', 'Автомоторная, 1', random.choice(metro), 'black', f'+7{randint(0000000000, 9999999999)}']]
